...
Os resultado dos testes confirmaram que existe uma diferença significativa entre as taxas de cliques dos grupos. O teste abaixo corrobora com nossas conclusões anteriores. Nós verificamos em um relatório anterior que como a distribuição da estimativa da diferença mediana entre as taxas incluia apenas números positivos maiores que zero. Isso nos levou a concluir que, assim como na nossa amostra, existia uma diferença significativa das taxas medianas entre os grupos também na população de onde os nossos dados foram originados. Nós pudemos ainda observar que as taxas de cliques no grupo A, em mediana, é maior que a taxa de cliques do outro grupo com adequada significância estatística (p-value < 6E-04, 0.05 significance level). Consequentemente, isso nós permite rejeitar a hipótese nula em favor da alternativa.
...
**Comentar sobre as vantagens e desvantagens que você vê no resultado ao qual chegou agora e utilizando ICs para as mesmas perguntas.** Observando o intervalo de confiança abaixo, podemos concluir com 95% de confiança, que existe uma diferença significativa entre as taxas medianas de cliques geral diária entre os grupos A e B na população de todas as buscas realizadas no Wikimedia. Além disso, podemos ainda concluir que, a mediana das taxas de cliques geral diária do grupo A é maior que a mediana das taxas de cliques geral diária do grupo B. Com relação à extensão ou relevância dessa diferença, podemos afirmar que ela não aparenta ser grande (~0.0347).
